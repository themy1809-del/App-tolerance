...
(function(){
  ...
  var rules = [
    ...
    { id:'iso286-H7-d6_18',
      ...
      permitted:{ kind:'REF', expression:'+0 / +18 µm (Ø6-10) · +0 / +21 µm (Ø10-18)', unit:'µm' },
    ...
    { id:'iso286-H7-d50',
      ...
      permitted:{ kind:'REF', expression:'+0 / +25 µm', unit:'µm' },
    ...
    { id:'iso286-H8-d50',
      ...
      permitted:{ kind:'REF', expression:'+0 / +39 µm', unit:'µm' },
    ...
    { id:'iso286-H11-d50',
      ...
      permitted:{ kind:'REF', expression:'+0 / +160 µm', unit:'µm' },
    ...
    { id:'iso286-h6-d50',
      ...
      permitted:{ kind:'REF', expression:'−16 / +0 µm', unit:'µm' },
    ...
    { id:'iso286-g6-d50',
      ...
      permitted:{ kind:'REF', expression:'−25 / −9 µm', unit:'µm' },
    ...
    { id:'iso286-k6-d50',
      ...
      permitted:{ kind:'REF', expression:'+2 / +18 µm', unit:'µm' },
    ...
    { id:'iso286-fit-H7g6',
      ...
      permitted:{ kind:'REF', expression:'Khe hở 9-50 µm tùy đường kính', unit:'µm' },
    ...
    { id:'iso286-fit-H7k6',
      ...
      permitted:{ kind:'REF', expression:'Lúc lỏng -2, lúc chặt +18 µm', unit:'µm' },
    ...
    { id:'iso286-fit-H7p6',
      ...
      permitted:{ kind:'REF', expression:'Ép từ +14 đến +35 µm', unit:'µm' },
    ...
    { id:'iso2768-f-link',
      ...
      permitted:{ kind:'REF',
        expression:'±0.05 (≤3) · ±0.05 (>3-6) · ±0.1 (>6-30) · ±0.15 (>30-120) · ±0.2 (>120-400)', unit:'mm' },
    ...
    { id:'iso2768-K-symm',
      ...
      permitted:{ kind:'REF', expression:'0.6 (≤100) · 0.8 (100-300) · 1.0 (300-1000)', unit:'mm' },
    ...
    { id:'iso2768-K-runout',
      ...
      permitted:{ kind:'REF', expression:'0.2 (toàn dải)', unit:'mm' },
    ...
    { id:'iso1101-flatness',
      ...
      permitted:{ kind:'REF', expression:'Theo giá trị trong khung GD&T' },
    ...
    { id:'iso1101-parallel',
      ...
      permitted:{ kind:'REF', expression:'Theo giá trị trong khung GD&T (vd: ∥ 0.05 A)' },
    ...
    { id:'iso1101-perp',
      ...
      permitted:{ kind:'REF', expression:'Theo khung GD&T (vd: ⟂ 0.02 A)' },
    ...
    { id:'iso1101-pos',
      ...
      permitted:{ kind:'REF', expression:'Theo khung GD&T (vd: ⊕ Ø0.1 A B C)' },
    ...
    { id:'iso1101-conc',
      ...
      permitted:{ kind:'REF', expression:'Theo khung GD&T (vd: ◎ Ø0.05 A)' },
    ...
    { id:'iso1101-runout',
      ...
      permitted:{ kind:'REF', expression:'Theo khung GD&T (vd: ↗ 0.05 A)' },
    ...
    { id:'iso965-6H-int',
      ...
      permitted:{ kind:'REF',
        expression:'Dung sai cốt trục theo M-size (vd M10: TD₂ = 132 µm)', unit:'µm' },
    ...
    { id:'iso965-6g-ext',
      ...
      permitted:{ kind:'REF',
        expression:'Td₂ theo M-size (vd M10×1.5: −32 / −172 µm)', unit:'µm' },
    ...
    { id:'iso13715-edge',
      ...
      permitted:{ kind:'REF', expression:'Theo ký hiệu bản vẽ: −0.3 (vê), +0.3 (bavia), ±0.3 (cả hai)' },
    ...
    // ========== ASME Y14.5 ==========
    { id:'asme-flatness',
      standard:'ASME Y14.5:2018', region:'US', sketch:'gdt_flatness',
      ...
      permitted:{ kind:'REF', expression:'Theo khung GD&T trên bản vẽ ANSI' },
    ...
    { id:'jis-b0405-m',
      ...
      permitted:{ kind:'REF', expression:'Bản chất tương đương ISO 2768-m', unit:'mm' },
    ...
    { id:'din7168-m',
      ...
      permitted:{ kind:'REF', expression:'Tương tự ISO 2768-m: ±0.1 (6-30) ±0.2 (30-120) ±0.3 (120-400)', unit:'mm' },
    ...
    { id:'iso286-1-itgrade',
      ...
      permitted:{ kind:'REF',
        expression:'IT6 = 16i · IT7 = 25i · IT8 = 39i · IT9 = 62i · IT10 = 100i (i = đơn vị cấp)' , unit:'µm' },
    ...
    { id:'iso286-1-fund-dev',
      ...
      permitted:{ kind:'REF', expression:'Chữ HOA = lỗ · chữ thường = trục' },
    ...
    { id:'iso286-1-fit-types',
      ...
      permitted:{ kind:'REF', expression:'Clearance (lỏng) · Transition (trung gian) · Interference (chặt)' },
    ...
    { id:'iso1302-symbol-basic',
      ...
      permitted:{ kind:'REF', expression:'Tam giác ✓ kèm số Ra (vd: Ra 3.2)' },
    ...
    { id:'iso1302-comparison-block',
      ...
      permitted:{ kind:'REF', expression:'Khối nhám chuẩn nhiều cấp Ra cùng phương pháp gia công' },
